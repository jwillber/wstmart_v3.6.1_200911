...
function pageQuery(){
    ...
    var cols = [
        ...
        {title:'提现账号信息', name:'accTargetName', width: 100,renderer:function(val,item,rowIndex){
        	if(item['accType']==1){
                return item['accNo'];
        	}else{
