...
class Carts extends Base{
	...
	public function getQuickCarts($uId=0){
		...
		$rs = Db::name('goods')->alias('g')
		           ...
		           ->where($where)
		           ->field('s.userId,s.shopId,s.shopName,g.goodsId,s.shopQQ,shopWangWang,g.goodsName,g.shopPrice,g.shopPrice defaultShopPrice,g.goodsStock,g.goodsImg,g.goodsCatId,g.isFreeShipping,s.isInvoice,g.goodsType')
		           ->find();
